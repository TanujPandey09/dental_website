      ...
      <div className="container mx-auto px-4 md:px-8 max-w-5xl text-center relative z-10">
        ...
        >
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-secondary/90 backdrop-blur-md text-white font-medium text-xs tracking-wider uppercase mb-8 shadow-sm border border-secondary/20"
          >
          ...
          <motion.h1
            variants={itemVariants}
            className="text-4xl md:text-6xl lg:text-[4.5rem] font-heading font-bold text-foreground leading-[1.05] tracking-tight mb-8"
          >
